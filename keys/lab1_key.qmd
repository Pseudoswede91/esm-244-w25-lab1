...
author: "Nathan Grimes, Yutian Fang, Casey O'Hara, and Allison Horst"
format: 
  html:
    code-fold: show
    toc: true
...
-   **Fork** this repo from GitHub (`https://github.com/nggrimes/esm-244-w25-lab1`) to create a version in your own user account
-   **Clone** to create a version controlled R project on your local computer
-   Create a new Quarto document in the project called `lab_1_<yourinitials>` (e.g. mine will be `lab_1_ng`)
